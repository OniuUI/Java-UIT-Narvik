...
public class chessProperties extends Application {
    @Override
    public void start(Stage primaryStage) {
        ...
        primaryStage.setTitle("Chess with properties.");
        ...
        for (int i=0; i<8; i++) {
            ...
            for (int e = 0; e < 8; e++, isWhite = !isWhite) {
                ...
                rectangle.yProperty().bind(pane.heightProperty().multiply(e).divide(8));
