...
public class ChatServer extends Application {
  ...
  /**
   * {@link TextArea} displaying LoanCalculatorSingleServer log
   */
  private TextArea taServer = new TextArea();

  /**
   * Constant variable used to limit number of clients connected to LoanCalculatorSingleServer
   */
  ...
  /**
   * Boolean determining whether or not the LoanCalculatorSingleServer is accepting new users
   */
  private boolean acceptingNewUsers;

  /**
   * Counts number of users connected to LoanCalculatorSingleServer
   */
  private int connectedUsers;

  /**
   * Determines port number that LoanCalculatorSingleServer uses
   */
  private static final int port = 2341;
  ...
  /**
   * Accepts new users as long as the LoanCalculatorSingleServer doesn't crash or the number of connected users doesn't exceed {@link ChatServer#MAX_USERS}
   */
  ...
  /**
   * Refuses new users as long as the LoanCalculatorSingleServer doesn't crash and {@link ChatServer#acceptingNewUsers} is false
   */
   ...
   * <br>
   * Class that establishes LoanCalculatorClient connection, reads messages from user and removes them if necessary
   *
   * @author Daniel Aaron Salwerowicz
   * @version 1.0
   * @since 2018-04-16
  ...
  private class AddUserToChat implements Runnable {
    ...
    /**
     * Connects user to LoanCalculatorSingleServer
     *
    ...
    private void establishUserConnection() throws IOException {
      ...
      // Read and save username and save OOS to user in outputToUsers in Helper.ChatServer class
    ...
    /**
     * Removes user from LoanCalculatorSingleServer
     */
    private void removeUser() {
      ...
      // If LoanCalculatorSingleServer doesn't accept new users, start accepting them once again
